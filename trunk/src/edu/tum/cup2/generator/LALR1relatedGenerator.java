...
/**
 * Common base class for LALR(1) related parser generators.
 * 
 ...
 */
public abstract class LALR1relatedGenerator	extends LRGenerator<LR1Item, LR1State>
{
	/**
	 * Computes a {@link LRParsingTable} for the given LR(1) specification.
	 */
	public LALR1relatedGenerator(CUPSpecification spec)
	 ...
	 * Computes a {@link LRParsingTable} for the given LR(1) specification.
	 */
	public LALR1relatedGenerator(CUPSpecification spec, Verbosity verbosity)
		throws GeneratorException
	{
	 ...
	 */
	public LALR1relatedGenerator(CUPSpecification spec, Verbosity verbosity, boolean extendGrammar)
		throws GeneratorException
	{
	 ...
	 */
	@Override public abstract Automaton<LR1Item, LR1State> createAutomaton()
		throws GeneratorException;
}
