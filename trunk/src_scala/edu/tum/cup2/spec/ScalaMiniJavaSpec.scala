...
import edu.tum.cup2.scanner.{TestScanner, ScannerTokenTest}
import java.io.{File}
 ...
 *
 */
class ScalaMiniJavaSpec extends CUPSpecification with ScalaCUPSpecification {
