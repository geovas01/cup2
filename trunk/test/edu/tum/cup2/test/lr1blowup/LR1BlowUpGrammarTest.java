...
public class LR1BlowUpGrammarTest
{
	...
	private CUPSpecification[] specsNoPrec = new CUPSpecification[]{
	...
	private CUPSpecification[] specsPrec = new CUPSpecification[]{
		...
		throws GeneratorException
	{
		...
		{
			CUPSpecification specNoPrec = specsNoPrec[i];
			CUPSpecification specPrec = specsPrec[i];
