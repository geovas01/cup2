...
import static edu.tum.cup2.test.semanticShiftActions.SpecificationTest1.NonTerminals.*;
import static edu.tum.cup2.test.semanticShiftActions.SpecificationTest1.Terminals.*;
	...
	public void specifyGrammar()
	{
      ...
      prod(S,
        rhs(a,SpecialTerminals.$a,b,d),
          new Action() {
          public String a(String a, String b) // METHOD TOO MUCH PARAMS in right hand side
          {
