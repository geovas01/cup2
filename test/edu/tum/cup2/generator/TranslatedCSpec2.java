...
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.arg_expr_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.assignment_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.assignment_op;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.case_statement;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.cast_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.compound_statement;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.cond_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.const_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.declaration;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.declaration_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.declaration_specifiers;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.declarator;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.direct_abstract_declarator;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.direct_declarator;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.enum_specifier;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.enumerator;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.enumerator_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.eq_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.excl_or_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.expr_stmt;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.expression;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.external_declaration;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.function_definition;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.identifier_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.incl_or_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.init_declarator;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.init_declarator_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.initializer;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.initializer_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.iteration_statement;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.jump_statement;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.labeled_statement;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.log_and_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.log_or_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.multiplicative_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.parameter_declaration;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.parameter_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.parameter_type_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.pointer;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.postfix_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.primary_expression;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.rel_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.selection_statement;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.shift_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.specifier_qualifier_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.statement;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.statement_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.storage_class_specifier;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.struct_declaration;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.struct_declaration_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.struct_declarator;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.struct_declarator_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.struct_or_union;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.struct_or_union_specifier;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.translation_unit;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.type_name;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.type_qualifier;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.type_qualifier_list;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.type_specifier;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.unary_expr;
import static edu.tum.cup2.generator.TranslatedCSpec2.NonTerminals.unary_operator;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.AUTO;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.BREAK;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.CASE;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.CHAR;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.CONST;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.CONSTANT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.CONTINUE;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.DEFAULT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.DIV;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.DIVGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.DO;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.DOPPELPUNKT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.DOUBLE;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.ELSE;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.ENUM;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.EXP;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.EXPGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.EXTERN;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.FLOAT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.FOR;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.FRAGEZEICHEN;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.GLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.GLEICHGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.GOTO;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.GROESSER;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.GROESSERGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.IDENTIFIER;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.IF;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.INT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.KLEINER;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.KLEINERGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.KOMMA;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.LONG;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.LPAR;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.LPARECKIG;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.LPARSCHWEIF;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.LSHIFT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.LSHIFTGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.MINUS;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.MINUSGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.MINUSMINUS;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.MOD;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.MODGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.MULT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.MULTGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.NICHT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.ODER;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.ODERGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.ODERODER;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.PFEIL;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.PLUS;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.PLUSGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.PLUSPLUS;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.PPP;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.PUNKT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.REGISTER;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.RETURN;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.RPAR;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.RPARECKIG;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.RPARSCHWEIF;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.RSHIFT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.RSHIFTGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.SEMIKOLON;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.SHORT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.SIGNED;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.SIZEOF;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.STATIC;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.STRING_LITERAL;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.STRUCT;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.SWITCH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.TILDE;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.TYPEDEF;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.TYPE_NAME;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.UND;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.UNDGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.UNDUND;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.UNGLEICH;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.UNION;
import static edu.tum.cup2.generator.TranslatedCSpec2.Terminals.UNSIGNED;
